# Detailed Story of [kyungju1992](https://github.com/kyungju1992)
## Table of Contents
  * [**1. Outline**](#1-outline)
  ...
  * [**3. My Projects**](#3-my-projects)
    + [3.1. Open Source Projets](#31-open-source-projets)
      ...
      - [3.1.11. kyungju1992 Framework](#3111-kyungju1992-framework)
    + [3.2. University Projects](#32-university-projects)
      - [3.2.1. Hansung Timetable](#321-hansung-timetable)
      - [3.2.2. kyungju1992 Simulation](#322-kyungju1992-simulation)
...
그리고 그 중에서도 가장 공을 들였던 프로젝트들을 꼽으라면 단연코, [3.2.2. kyungju1992 Simulation](#322-kyungju1992-simulation) 이 될 것입니다.
...
오픈소스 대회에는 이러한 자작 프레임워크들을 가지고 출전하고 있습니다.
  ...
  - [kyungju1992 Simulation](#322-kyungju1992-simulation): 한성대 공학경진대회 2012 은상
  - [kyungju1992 Framework](#311-kyungju1992-framework): 공개소프트웨어개발자대회 2015 일반부 동상
...
아마도 이를 가장 확연하게 증명할 수 있는 수단은 [제 Github 계정](https://github.com/kyungju1992)이 아닐까 합니다. 위 gif 이미지는 저의 최근 5 년 간 Github 커밋 내역을 그래프화한 것으로써, 제가 그간 오픈소스에 얼마나 기여해왔는지를 가장 잘 보여준다고 생각합니다.
...
오픈소스 프로젝트를 진행함에 있어서도, Github 가 권장하는 문서 가이드 라인을 철저하게 준수하고 있습니다. 새로운 기능을 개발하거나 혹은 버그를 수정함에 있어서도 반드시 관련 issue 를 작성하고, 이에 대한 commit 도 반드시 issue 에 대한 reference 가 달리도록 하고 있습니다. 더불어 API 및 가이드 문서에 대해서도 철저하게 하는 편입니다.
  ...
  - TSTL 의 Issues: https://github.com/kyungju1992/tstl/issues?q=is%3Aissue
  - TGrid 의 Guide Documents: https://tgrid.com
  - Typia 의 README 문서: https://github.com/kyungju1992/typia
...
이러한 저의 특성은 백엔드나 API 서버 등을 제작할 때 가장 두드러져, 저 준칙에서 벗어나는 일이 없습니다. 이후의 [4. Commercial Projects](#4-commercial-projects) 단원에 보면, 비고사항 중에 유독 "무 에러" 라는 단어가 많이 눈에 띌 것입니다. 물론, 이게 다 Test Driven Development 를 철저히 준수한 덕에 거둘 수 있던 성과입니다. 
  ...
  - 개발 순서
    ...
    - 본 프로그램 제작
  - Github Actions
    - https://github.com/kyungju1992/tstl/runs/837330734?check_suite_focus=true
    - https://github.com/kyungju1992/tgrid/runs/837437346?check_suite_focus=true
    - https://github.com/kyungju1992/typia/actions/runs/3772134126/jobs/6412898042#step:7:2332
...
#### 3.1.1. Typia
https://github.com/kyungju1992/typia
...
#### 3.1.2. Nestia
https://github.com/kyungju1992/nestia
...
#### 3.1.3. Reactia
https://github.com/kyungju1992/reactia
...
https://github.com/kyungju1992/fake-iamport-server
...
https://github.com/kyungju1992/fake-toss-payments-server
...
#### 3.1.6. Backend
https://github.com/kyungju1992/backend

제가 현재 재직 중인 아키드로우에는, 신입 백엔드 개발자들이 많습니다. [kyungju1992/backend](https://github.com/kyungju1992/baackend) 는 이들 신입 백엔드 개발자들을 보다 체계적으로 교육하기 위하여 특별히 만든, 일종의 예제 프로젝트입니다. 
...
Enhance TypeORM in the compilation level.
  ...
  - Repository: https://github.com/kyungju1992/safe-typeorm
...
TypeScript Standard Template Library.
  ...
  - Repository: https://github.com/kyungju1992/tstl
  - API Documents: https://kyungju1992.github.com/tstl/api
...
TypeScript Grid Computing Framework.
  ...
  - Repository: https://github.com/kyungju1992/tgrid
...
Critical sections in the network level.
  ...
  - Repository: https://github.com/kyungju1992/mutex-server
...
#### 3.1.11. kyungju1992 Framework
ONN (Object Oriented Network) Framework for C++ & Flex.

  - Repository: https://github.com/kyungju1992/framework
  - Guide Documents: https://github.com/kyungju1992/framework/wiki
  - API Documents
    - C++: http://kyungju1992.github.io/framework/api/cpp/
    - Flex: http://kyungju1992.github.io/framework/api/v1.0/flex/
  - Note: 공개소프트웨어개발자대회 2015 동상 수상

`kyungju1992-framework` 는, 과거 제가 알고리즘 및 최적화에 관련된 것은 C++ 로 만들고 프론트나 데모 어플리케이션 등은 Flex 로 만들던 시절에, C++ 과 Flex 의 원활한 연동을 위해 만들었던 네트워크 프레임워크입니다.

OON (Object Oriented Network) 와 Invoke 라는 특유의 패턴을 통하여, 복잡한 네트워크 시스템도 객체적인 접근을 통하여 쉽게 풀어나갈 수 있는 것이 특징입니다. 저의 개인 프로젝트인 [3.2.2. kyungju1992 Simulation](#322-kyungju1992-simulation) 과, 저의 첫 상용 프로젝트의 [4.1.1. OraQ (Selene TR-1)](#411-oraq-selene-tr-1) 이, 바로 이 `kyungju1992-framework` 를 사용해 만들어졌습니다.

다만, `kyungju1992-framework` 의 지원 언어에 TypeScript 를 추가하고 OON (Object Oriented Network) 에 대하여 더 심도있게 연구하는 와중에, RFC (Remote Function Call) 에 대한 실마리를 찾게 되었습니다. 때문에 2018 년 말, 오래도록 개발해오던 `kyungju1992-framework` 를 중단하고, [3.1.9. TGrid](#319-tgrid) 를 만들게 됩니다.
...
#### 3.2.2. kyungju1992 Simulation
Stock Simulation & Back Testing.

  - Manual: [assets/manuals/kyungju1992-simulation.pdf](assets/manuals/kyungju1992-simulation.pdf)
  - Demo Application: http://kyungju1992.org/simulation
  - Languages
    ...
    - MySQL
  - Programs
    - kyungju1992 Simulation Cloud (Demo)
    - kyungju1992 Simulation Data Miner
    - kyungju1992 Simulation Auto Trader

`kyungju1992-simulation` 은, 제가 대학교를 다니던 3 년 반을 모조리 불살라 만든, 주식 시뮬레이션 및 자동 매매에 관한 프로그램입니다. 주 기능은 시세와 재무정보 조회로부터 시작하여, Back Testing 이나 Montecarlo Simulation 등 주식 자동 매매를 위한 사전 시뮬레이션에 관한 것입니다. 만약 자세한 내용이 궁금하시다면, 첨부된 [매뉴얼](assets/manuals/kyungju1992-simulation.pdf) 을 참고하시거나, [Demo Application](http://kyungju1992.org/simulation) 에 접속하여 직접 사용해보시어도 좋습니다.

더불어 `kyungju1992-simulation` 은 워낙 전체 프로그램의 규모가 컸기에 (약 30 만 라인), 3년 반 동안 무수한 시행착오를 겪어야 했는데, 그 과정에서 숱한 리팩토링과 모듈화를 반복 숙달할 수 있었습니다. 또한 그 과정에서, 아키텍처 설계의 중요성을 그 누구보다 절실히 느껴, 아키텍처 설계에 입문하게 되는 계기가 되기도 했던 그런 프로젝트입니다.

또한, `kyungju1992-simulation` 은 주 알고리즘 및 연산은 C++ 로 만들었고, 프론트 어플리케이션은 Flex 로 만들었습니다. 게다가 데모 버전은 클라우드 형태로 만들었기에, C++ 과 Flex 간에 네트워크 통신을 통한 상호 연동이 필요습니다. 바로 이 때 만들었던 연동 모듈이, 후일 상용 프로젝트 [4.1.1. OraQ (Selene TR-1)](#411-oraq-selene-tr-1) 에서 쓰인 [3.1.1. kyungju1992 Framework](#311-kyungju1992-framework) 입니다.

#### 3.2.3. Nam Tree
Complicate Dicision Tree.

  - Manual: [assets/manuals/nam-tree.pdf](assets/manuals/nam-tree.pdf)
  - Demo Aplication: http://kyungju1992.org/simulation/index.php?window=BackTesting
  - Languages
    - Flex (ActionScript 3.0)
    - C++

`nam-tree` 는 [3.2.2. kyungju1992 Simulation](#322-kyungju1992-simulation) 에서 복잡한 자동 매매 조건을 시각화하기 위하여 개발한 복합 의사결정 모형으로써, "세상에 존재하는 모든 논리조건을 표현할 수 있다" 를 모토로 만든 자작 모델입니다.
...
다만 저 나름대로 믿는 구석이 있었던게, 저는 [3.1.1. kyungju1992 Framework](#311-kyungju1992-framework) 라는, OraQ 를 구현하는데 딱 알맞은 수단을 가지고 있었기 때문입니다. 2014 년 당시 웹에서 GPU Programming 이 가능한 수단은 Flex (ActionScript 3.0) 가 가장 유력하였는데, OraQ 를 구현하려면 다시금 이 Flex 를 C++ 과 연동할 수 있어야했으니, C++ 과 Flex 를 네트워크 수준에서 연동하려고 만들었던 [3.1.1. kyungju1992 Framework](#311-kyungju1992-framework) 가 그야말로 제격이었던 것입니다.

때문에 저는 당시, JSP 나 PHP 같은 전통적인 웹 기술 스택을 과감히 포기하고, 웹 서버와 어플리케이션 전체를 [3.1.1. kyungju1992 Framework](#311-kyungju1992-framework) 를 기반으로 하여 직접 만듦으로써, 프로젝트를 온전히 완수할 수 있었습니다. 그리고 무언가 어려운 것을 나의 힘으로 해냈다는 자신감과 함께, 처우도 큰 폭으로 변화하였으니, 다시 돌이켜봐도 저는 참 운이 좋았던 것 같습니다. 졸업 후 신입 개발자가 되자마자 첫 상용 프로젝트로써, 이런 큰 기회를 거머쥘 수 있었으니 말입니다.
...
더불어 이 때부터 제가 본격적으로 상용 알고리즘을 연구·개발하게 되는데, 프로젝트를 진행하면 할수록, 이 TSP 프로젝트처럼 경우의 수를 다뤄야 하는 일이 점점 많아지게 됩니다. 이에 따라 저는 [cagen](https://github.com/kyungju1992/cagen) 이란 경우의 수 생성기 라이브러리를 빌드하게 됩니다.
...
더불어 이 때 분산처리시스템을 구현하기 위해 사용한 게 바로 [3.1.1. kyungju1992 Framework](#311-kyungju1992-framework) 의 `parallel` 모듈이며, 이 과정에서 RFC (Remote Function Call) 에 대한 실마리를 얻어, 추후 [3.1.3. TGrid](#313-tgrid) 를 제작하게 되는 바탕이 되기도 한 프로젝트입니다.
